...
labelframe = LabelFrame(win, text="Rock Paper Scissor", font=('Century 20 bold'), labelanchor="n", bd=5, bg="sky blue", width=600, height=450, cursor="target")
labelframe.pack(expand=True, fill=BOTH)

# Label for Player
l1 = Label(labelframe, text="Player", font=('Helvetica 18 bold'))
l1.place(relx=.18, rely=.1)
l2 = Label(labelframe, text="VS", font=('Helvetica 18 bold'), bg="sky blue")
l2.place(relx=.45, rely=.1)
l3 = Label(labelframe, text="Computer", font=('Helvetica 18 bold'))
l3.place(relx=.65, rely=.1)

label = Label(labelframe, text="", font=('Coveat', 25, 'bold'), bg="sky blue")
label.pack(pady=150)
